...
buf.push("<div class=\"oscillator component\"><div class=\"remove-button\"></div><div class=\"title\">Oscillator</div><div class=\"inputs\"><div" + (jade.attr("data-connection-id", "" + (addInputId) + "", true, false)) + " class=\"add-input input\"><div class=\"port\"></div>Add</div><div" + (jade.attr("data-connection-id", "" + (multiplyInputId) + "", true, false)) + " class=\"multiply-input input\"><div class=\"port\"></div>Multiply</div></div><div" + (jade.attr("data-connection-id", "" + (outputId) + "", true, false)) + " class=\"output\"><div class=\"port\"></div>Output</div><div class=\"output-display\"><svg class=\"waveform\"></svg><div class=\"measure-bars\"></div></div><div class=\"waveform-display\"><!--shows waveform for length of this pattern--><svg class=\"waveform\"></svg><div class=\"measure-bars\"></div></div></div>");}.call(this,"addInputId" in locals_for_with?locals_for_with.addInputId:typeof addInputId!=="undefined"?addInputId:undefined,"multiplyInputId" in locals_for_with?locals_for_with.multiplyInputId:typeof multiplyInputId!=="undefined"?multiplyInputId:undefined,"outputId" in locals_for_with?locals_for_with.outputId:typeof outputId!=="undefined"?outputId:undefined));;return buf.join("");
},
