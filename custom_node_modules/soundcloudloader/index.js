...
var SC = require("soundcloud-node")(client_id);
/**
            ...
            if (sound.errors) {
                ...
                if (sound.kind == "playlist") {
                    ...
                    self.streamUrl = function() {
                        return sound.tracks[self.streamPlaylistIndex]
                            .stream_url +
                            '?client_id=' + client_id;
                    };
    ...
    this.directStream = function(direction) {
        if (direction == 'toggle') {
            ...
            if (direction == 'coasting') {
                ...
                if (this.streamPlaylistIndex >= this.sound.track_count -
                    1) this.streamPlaylistIndex =
                    0;
                else this.streamPlaylistIndex++;
            } else {
                if (this.streamPlaylistIndex <= 0) this.streamPlaylistIndex =
                    this.sound.track_count -
                    1;
                else this.streamPlaylistIndex--;
            }
            if (this.streamPlaylistIndex >= 0 && this.streamPlaylistIndex <=
