...
function createStylesheet(){
	...
	return FS.read("./templates/sass.ust")
		.then(function(filecontents){
			var content = _.template(filecontents)({pagename:pagename});
			FS.write(src + "/sass/pages/_" + pagename + ".sass", content);
		});
}

function createView(){
	console.log(">>".green, "Creating Backbone View");
	return FS.read("./templates/view.ust")
		.then(function(filecontents){
			var content = _.template(filecontents)({pagename:pagename});
			FS.write(src + "/js/views/pages/" + pagename + ".js", content);
		});
}

function createTemplate(){
	console.log(">>".green, "Creating JADE Template");
	return FS.read("./templates/jade.ust")
		.then(function(filecontents){
			var content = _.template(filecontents)({pagename:pagename});
